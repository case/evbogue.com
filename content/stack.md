...
I figured it might be interesting to you if I wrote a little bit about what I'm using my stack, so you can have a specific perspective to compare your current stack.
...
I started deploying an Arch Linux VPS using Digital Ocean (rewards link). These are only 5 dollars, and deploy with one click. Digital Ocean emails the root password to me, I log in and customize the Arch Linux installation to suit my needs. I create a non-root user, and change all of my passwords to keep things secure. 
...
I use Node.js to create tiny web servers. evbogue.com is running on Node using Express, Jade, Stylus, and Embittered. I call this specific node web server configuration Bitters. 
